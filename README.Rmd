...
This is a quick way to enable code-folding, for an entire page, on a page-by-page basis. The idea is to put an Rmd-chunk, presumably, near the top of a page. When rendered, the chunk places a button in the right margin which can be used to show or hide code.
